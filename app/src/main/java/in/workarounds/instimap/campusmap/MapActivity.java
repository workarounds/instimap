...
import in.workarounds.instimap.data.Building;
import in.workarounds.instimap.data.Locations;
import in.workarounds.instimap.data.MapEvent;
import in.workarounds.instimap.data.Marker;
import in.workarounds.instimap.data.Room;
import in.workarounds.instimap.data.UpdateLocations;
import in.workarounds.instimap.data.UpdateMapEvents;
import in.workarounds.instimap.navigation.CardSlideListener;
import in.workarounds.instimap.navigation.SlidingUpPanelLayout;
import in.workarounds.instimap.zoomview.CampusMapView;
import in.workarounds.instimap.zoomview.SubsamplingScaleImageView;
...
public class MapActivity extends ActionBarActivity implements TextWatcher,
    ...
    public static final String AUTHORITY = "in.workarounds.provider";
    // The account name
...
//        String account_type = getResources().getString(R.string.account_type);
        ...
        Account newAccount = new Account(
                ACCOUNT, "in.workarounds.instimap");
