...
public class Locations {
	...
	public Locations(Context context) {
		...
		data.put(m0.name, m0);
		Marker m1 = new Marker("Ananta", "0", 4695, 925, 3, "");
		data.put(m1.name, m1);
		Marker m2 = new Marker("Aravali", "0", 4404, 968, 3, "");
		data.put(m2.name, m2);
		Marker m3 = new Room("ATM - Canara Bank near Gulmohar", "Canara ATM",
				2989, 2154, 6, "Canara Bank", "First floor", "");
		data.put(m3.name, m3);
		Marker m4 = new Room("ATM - Canara Bank near H6", "Canara ATM", 2500,
				748, 6, "Hostel 06", "Near", "");
		data.put(m4.name, m4);
		Marker m5 = new Room("ATM - State Bank near Tansa", "SBI ATM", 3028,
				989, 6, "Tansa House (Proj. Staff Boys)", "Near", "");
		data.put(m5.name, m5);
		...
		data.put(m8.name, m8);
		Marker m9 = new Marker("Boat House", "0", 1960, 1757, 9,
				"Timings: 6 am to 6 pm");
		data.put(m9.name, m9);
		Marker m10 = new Room("Brewberrys Cafe", "Brewberrys", 2967, 1271, 5,
				"Hostel 08", "Inside",
				"Ph no: 022 65641001, Hostel 8, IIT Bombay, Powai, Mumbai");
		data.put(m10.name, m10);
		Marker m11 = new Marker(
				"Campus School",
				"0",
				3331,
				2865,
		...
		Marker m17 = new Building(
				...
				1344,
				1,
				new String[] { "SAIF Sophisticated Analytical Instruments Facility" },
		...
		Marker m19 = new Marker("Director Bungalow", "Dir. Bunglw.", 2593,
				2408, 3, "");
		data.put(m19.name, m19);
		Marker m20 = new Marker(
				"DRDO Defence Research & Development Organization", "DRDO",
				4125, 1048, 3, "");
		data.put(m20.name, m20);
		Marker m21 = new Marker(
		...
		Marker m22 = new Marker("Electrical Engineering Annex Building",
		...
		Marker m25 = new Marker("Electrical Maintenence", "Elec Maint", 4544,
				1830, 1, "022 2576 7971/4077");
		data.put(m25.name, m25);
		Marker m26 = new Marker("Guest House/ Jalvihar", "Jalvihar", 2610,
				2138, 3, "022 2576 8940/8942/8943");
		m26.imageUri = "jalvihar";
		data.put(m26.name, m26);
		Marker m27 = new Marker("Guest House/ Vanvihar", "Vanvihar", 2881,
				2106, 3, "022 2576 1200/8945");
		m27.imageUri = "vanvihar";
		data.put(m27.name, m27);
		Marker m28 = new Room("Gulmohar Restaurant", "Gulmohar", 2989, 2154, 5,
				"Canara Bank", "Second floor", "022 2576 2783/2786");
		m28.imageUri = "gulmohar";
		data.put(m28.name, m28);
		Marker m29 = new Marker(
				"Hospital",
				"Hosp.",
				3018,
				1917,
				9,
				"Add these numbers to your speed dial for emergency\n+919167398598\n+919167398599\n+919833337979\n+919833338989\nHospital 022 2576 7051,\nAmbulance 022 2576 1101");
		data.put(m29.name, m29);
		Marker m30 = new Marker(
				"Hostel 01",
				"H1",
				3908,
				1077,
		...
		Marker m33 = new Marker("Hostel 10A Girls QIP building (P. Staff)",
				"H10 QIP", 4716, 1448, 2,
				"Hostel security: 022-2576\nHall Manager: 022-2576\nG.Sec:");
		data.put(m33.name, m33);
		Marker m34 = new Building(
		...
		Marker m50 = new Marker("Indoor Stadium", "0", 3480, 1081, 8, "");
		data.put(m50.name, m50);
		Marker m51 = new Room(
				"IRCC Industrial Research & Consultancy Centre",
				"IRCC",
				3505,
				1867,
				1,
		...
		Marker m53 = new Marker("Kshitij Udyan", "0", 2971, 1744, 9, "");
		data.put(m53.name, m53);
		Marker m54 = new Marker("KV Kendriya Vidyalaya ", "KV", 3883, 2714, 7,
				"022 2576 8983");
		...
		m58.imageUri = "mainbuilding";
		data.put(m58.name, m58);
		Marker m59 = new Building("Main Gate", "0", 2259, 3237, 10,
		...
		Marker m63 = new Marker("Medical Store", "Med. Store", 4000, 2808, 9,
				"");
		...
		Marker m65 = new Marker("NASA Non- Academic Staff Association", "NASA",
		...
		Marker m69 = new Marker("Nilgiri B 24", "B 24", 3318, 2324, 3, "");
		...
		Marker m71 = new Marker("Old Multistoried Building- Residence", "0",
		...
		Marker m74 = new Marker("Padmavati Devi Temple", "0", 946, 2178, 9, "");
		data.put(m74.name, m74);
		Marker m75 = new Marker("PC Saxena Auditorium (LT)", "PCSA, LT", 3648,
				1790, 4, "022 2576 4999");
		...
		Marker m77 = new Marker("Post Office", "0", 3918, 2846, 9,
				"022 2576 2774");
		data.put(m77.name, m77);
		Marker m78 = new Marker("Power House", "0", 4671, 1590, 9, "");
		data.put(m78.name, m78);
		Marker m79 = new Marker("Printing Press", "Press", 4326, 1896, 9,
				"022 2576 8961");
		data.put(m79.name, m79);
		Marker m80 = new Marker("SAC Students Activity Centre", "SAC", 3599,
		...
		Marker m82 = new Marker("Seminar Hall", "0", 3792, 2025, 4,
				"022 2576 4912, for booking 022 2576 4420");
		data.put(m82.name, m82);
		Marker m83 = new Marker("Shishu Vihar", "0", 2949, 1495, 9, "");
		data.put(m83.name, m83);
		Marker m84 = new Marker("Shivalik C 23", "C 23", 3129, 2612, 3, "");
		data.put(m84.name, m84);
		Marker m85 = new Building(
				"SOM School of Management",
				"SOM",
				3505,
				1867,
				1,
				new String[] { "IRCC Industrial Research & Consultancy Centre" },
		...
		Marker m86 = new Marker("Staff Canteen", "Staff Cant.", 3622, 1547, 5,
				"022 2576 8952");
		data.put(m86.name, m86);
		Marker m87 = new Marker("Staff Club", "0", 2931, 2027, 8,
				"022 3576 4075");
		data.put(m87.name, m87);
		Marker m88 = new Marker("Staff Hostel", "0", 2872, 1472, 3,
				"022 2576 1113");
		data.put(m88.name, m88);
		Marker m89 = new Room("SBI State Bank of India, IIT Powai branch",
				"SBI", 2259, 3237, 6, "Main Gate", "Near",
				"Phone (022) 25722894-25721103\nFax\nwork hours: 10:30 am to 4:30 pm");
		data.put(m89.name, m89);
		Marker m90 = new Marker("Swimming Pool (new)", "S. Pool new", 3558,
				1141, 8, "022 2576 2755");
		data.put(m90.name, m90);
		Marker m91 = new Marker("Swimming Pool (old)", "S. Pool old", 3742,
				1229, 8, "022 2576 8967");
		data.put(m91.name, m91);
		Marker m92 = new Building("Tansa House (Proj. Staff Boys)", "Tansa",
				3028, 932, 2, new String[] { "ATM - State Bank near Tansa" },
				"022 2576 2620");
		data.put(m92.name, m92);
		Marker m93 = new Marker("Tennis Court (new)", "0", 3046, 1513, 8, "");
		data.put(m93.name, m93);
		Marker m94 = new Marker("Tennis Court (old)", "0", 3177, 1624, 8, "");
		data.put(m94.name, m94);
		Marker m95 = new Marker("VMCC Victor Menezes Convention Centre",
				"VMCC", 4110, 1847, 4, "022 2576 1125");
		m95.imageUri = "vmcc";
		data.put(m95.name, m95);
		Marker m96 = new Marker("Vidya Niwas", "0", 4911, 1111, 3, "");
		data.put(m96.name, m96);
		Marker m97 = new Marker("Vihar House", "0", 4558, 1429, 3, "");
		data.put(m97.name, m97);
		Marker m98 = new Marker("White House", "0", 1909, 2799, 3,
		...
		Marker m100 = new Room("HCU Hostel Coordinating Unit", "HCU", 3628,
				...
				"Chairman 022 2576 8901,\nOffice 022 2576 8900");
		data.put(m100.name, m100);
		Marker m101 = new Room(
				"GATE Graduate apptitude test in engineering Office",
				"GATE Off.", 3628, 1640, 1, "Main Building", "Inside",
				"022 2576 2924");
		data.put(m101.name, m101);
		Marker m102 = new Room("JAM Joint Admission Test for M.Sc. Office",
				"JAM Off.", 3628, 1640, 1, "Main Building", "Inside",
				"022 2576 2924");
		data.put(m102.name, m102);
		Marker m103 = new Room("JEE Joint Entrance Examination Office",
				"JEE Off.", 3628, 1640, 1, "Main Building", "Inside",
				"022 2576 4063");
		data.put(m103.name, m103);
		Marker m104 = new Room("Centrifugal Lab", "0", 4370, 1395, 12,
				"National Geotechnical Centrifuge Facility", "", "");
		data.put(m104.name, m104);
		Marker m105 = new Room(
		...
		Marker m106 = new Marker("Cummins Engine Research facility", "Cummins",
				4350, 1580, 1,
				"Incharge: Prof. Anuradda Ganesh\n022 2576 4506\nLocation");
		data.put(m106.name, m106);
		Marker m107 = new Building(
				"ENELEK Power Sine",
				"ENELEK",
				4160,
				1620,
				9,
				new String[] { "Bio-diesel Lab" },
		...
		Marker m111 = new Building("Geotechnical Engg. Lab", "GeoTech Lab",
		...
		Marker m113 = new Room("Greenhouse Lab", "0", 4790, 1055, 12,
				"K-Yantra Lab (CSE Dept.)", "Inside", "");
		data.put(m113.name, m113);
		Marker m114 = new Marker("Heat Pump Lab", "0", 4153, 1539, 12,
				"Comes under Mechanical Engineering Department\n022 2576 4527/4593");
		data.put(m114.name, m114);
		Marker m115 = new Building("Heat Transfer and Thermodynamic Lab",
		...
		Marker m117 = new Building(
				"Hydraulics Lab",
				"0",
				4215,
				1490,
				12,
				new String[] { "Heavy Structure Lab",
						"Hydraulics Lab Workshop",
		...
		Marker m122 = new Room("Machine Lab", "0", 1445, 1669, 12, "N2 Bay",
				"",
				"Comes under Electrical Engineering Department\n022 2576 4422");
		data.put(m122.name, m122);
		Marker m123 = new Room("Machine Tool Lab", "0", 4410, 1740, 12,
				"S2 Bay", "",
				"Comes under Mechanical Engineering Department\n022 2576 4518/4537");
		data.put(m123.name, m123);
		Marker m124 = new Room("Metal Forming Lab", "0", 4290, 1470, 12,
				"SEMT Lab /Structural Evaluation & Material Technologies Lab",
				"",
				"Comes under Mechanical Engineering Department\n022 2576 4561");
		data.put(m124.name, m124);
		Marker m125 = new Marker("Micro Fluidics Lab", "0", 1620, 1783, 12, "");
		data.put(m125.name, m125);
		Marker m126 = new Building("N1 Bay", "0", 4525, 1680, 1,
				new String[] { "Fuel Cell Research Facility" },
				"Comes under Chemical Engineering Department\n022 2576 4211");
		data.put(m126.name, m126);
		Marker m127 = new Building("N2 Bay", "0", 1445, 1669, 1,
				new String[] { "Machine Lab" }, "");
		data.put(m127.name, m127);
		Marker m128 = new Marker("N3 Bay", "0", 4360, 1645, 1, "");
		data.put(m128.name, m128);
		Marker m129 = new Building("National Geotechnical Centrifuge Facility",
				"GeoTech Centrifuge", 4370, 1395, 1,
				new String[] { "Centrifugal Lab" }, "");
		data.put(m129.name, m129);
		Marker m130 = new Marker("OrthoCad Lab", "0", 4683, 1702, 12,
				"Comes under Mechanical Engineering Department\n022 2576 4399");
		data.put(m130.name, m130);
		Marker m131 = new Room("Old ONGC Lab", "0", 4275, 1555, 12,
				"IC Engine and Combustion Lab", "", "");
		data.put(m131.name, m131);
		Marker m132 = new Building("Physics Lab (Ist Years)", "Phy Lab (1 Yr)",
				4585, 1540, 12, new String[] { "UG Lab (Ist Years)" },
				"Comes under Physics department");
		data.put(m132.name, m132);
		Marker m133 = new Room("Refrigeration, A/C and Cryogenics Lab", "0",
				4225, 1630, 12, "Treelabs", "",
				"Comes under Mechanical Engineering Department\n022 2576 4587");
		data.put(m133.name, m133);
		Marker m134 = new Marker("RM Lab (Rapid manufacturing)", "RM Lab",
				4650, 1757, 12, "");
		data.put(m134.name, m134);
		Marker m135 = new Room("Rock Cutting Lab", "0", 3921, 2095, 12,
				"Rock Powdering Lab", "", "");
		data.put(m135.name, m135);
		Marker m136 = new Building("Rock Powdering Lab", "0", 3921, 2095, 12,
				new String[] { "Rock Cutting Lab" }, "");
		data.put(m136.name, m136);
		Marker m137 = new Building(
				"S1 Bay",
				"0",
				4490,
				1760,
				1,
				new String[] { "Supercritical fluid Processing facility (Chemical Engg.)" },
				"");
		data.put(m137.name, m137);
		Marker m138 = new Building("S2 Bay", "0", 4410, 1740, 1, new String[] {
				"Machine Tool Lab", "UG Lab/S2 Bay" }, "022 2576 4213");
		data.put(m138.name, m138);
		Marker m139 = new Marker("S3 Bay", "0", 4325, 1720, 1, "");
		data.put(m139.name, m139);
		Marker m140 = new Room(
				"SEMT Lab /Structural Evaluation & Material Technologies Lab",
				"SEMT Lab", 4280, 1510, 12, "Hydraulics Lab", "Near",
				"Comes under Civil Engineering Department\n022 2576 4318");
		data.put(m140.name, m140);
		Marker m141 = new Marker(
				"SITAC/ Structural integrity Testing and Analysis Centre",
				"SITAC", 4355, 1750, 1,
				"Comes under Mechanical Engineering Department\n022 2576 4528");
		data.put(m141.name, m141);
		Marker m142 = new Room(
				"Solar Lab",
				"0",
				4230,
				1435,
		...
		Marker m143 = new Room("Steam Power Lab", "0", 4376, 1526, 12,
				"Heat Transfer and Thermodynamic Lab", "",
				"Comes under Mechanical Engineering Department\n022 2576 4584");
		data.put(m143.name, m143);
		Marker m144 = new Marker(
		...
		Marker m147 = new Room("Tinkerers Lab (STAB)", "0", 4225, 1630, 12,
				"Treelabs", "", "");
		data.put(m147.name, m147);
		Marker m148 = new Building(
				"Treelabs",
				"0",
				4225,
				1630,
				9,
				new String[] { "IC Engine and Combustion Lab",
		...
		Marker m149 = new Room("UG Lab/S2 Bay", "0", 4410, 1740, 12, "S2 Bay",
				"",
				"Comes under Chemical Engineering Department \n022 2576 4207");
		data.put(m149.name, m149);
		Marker m150 = new Room("UG Lab (Ist Years)", "0", 4585, 1540, 12,
				"Physics Lab (Ist Years)", "", "");
		data.put(m150.name, m150);
		Marker m151 = new Room("Printing and photocopying H11", "Prints", 2987,
				1368, 11, "Hostel 11 Girls Hostel", "Inside", "");
		data.put(m151.name, m151);
		Marker m152 = new Room("Printing and photocopying H8", "Prints", 2834,
				1257, 11, "Hostel 08", "Inside", "");
		data.put(m152.name, m152);
		Marker m153 = new Room("Printing and photocopying Main Building",
				"Prints", 3628, 1640, 11, "Main Building", "Inside", "");
		data.put(m153.name, m153);
		Marker m154 = new Room("ATM - State Bank main gate", "SBI ATM", 2259,
				3237, 6, "Main Gate", "at", "");
		data.put(m154.name, m154);
		Marker m155 = new Room("KReSIT Canteen", "KReSIT Canteen", 3301, 2106,
				5, "KReSIT Kanwal Rekhi School of Information Technology ",
				"Inside", "From 10 to 8. Samosas run out by 5:30ish though!");
		data.put(m155.name, m155);
		Marker m156 = new Room("IDC Canteen", "IDC Cant.", 4207, 1732, 5,
				"IDC Industrial Design Centre", "Inside",
				"Santosh bhaiyas Canteen 9am to 5:30 pm, weekdays only");
		data.put(m156.name, m156);
		Marker m157 = new Room("IDC Shakti", "Shakti", 4207, 1732, 5,
				"IDC Industrial Design Centre", "Inside",
				"Piping hot, home style food between 1 pm and 3 pm, weekdays only!");
		data.put(m157.name, m157);
		Marker m158 = new Room("H13 Night Canteen", "H13 Night Cant.", 1918,
